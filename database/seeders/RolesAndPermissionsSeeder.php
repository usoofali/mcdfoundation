...
class RolesAndPermissionsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $permissions = [
            ...
            'Dependents' => [
                'view_dependents' => 'View dependent details',
                'create_dependents' => 'Add new dependents',
                'edit_dependents' => 'Edit existing dependents',
                'delete_dependents' => 'Delete dependents',
            ],
            'Contributions' => [
            ...
            'Cashout' => [
                'request_cashout' => 'Submit cashout request (members only)',
                'verify_cashout' => 'Verify cashout requests',
                'approve_cashout' => 'Approve cashout requests',
                'disburse_cashout' => 'Process cashout disbursements',
                'view_cashout' => 'View cashout records',
            ],
            'Reports' => [
        ...
        $roles = [
            ...
            'Member' => [
                'description' => 'Regular member with access to personal records and services',
                'permissions' => [
