...
class StatesAndLgasSeeder extends Seeder
{
    public function run(): void
    {
        $states = [
            ...
            'Benue' => [
                'Ado', 'Agatu', 'Apa', 'Adoka', 'Buruku', 'Gboko', 'Guma', 'Gwer East', 'Gwer West',
            ...
            'Delta' => [
                ...
                'Okpe', 'Oshimili North', 'Oshimili South', 'Patani', 'Sapele', 'Udu', 'Ukwuani',
            ...
            'Kano' => [
                ...
                'Rano', 'Rimin Gado', 'Rogo', 'Shanono', 'Shanono', 'Sumaila', 'Takai', 'Tarauni',
                'Tofa', 'Tsanyawa', 'Tudun Wada', 'Ungogo', 'Warawa', 'Wudil',
            ],
            'Katsina' => [
                'Bakori', 'Batagarawa', 'Batsari', 'Baure', 'Bindawa', 'Charanchi', 'Dandume',
                'Danja', 'Dan Musa', 'Dutsin Ma', 'Faskari', 'Funtua', 'Ingawa', 'Jibia', 'Kafur',
            ...
            'Oyo' => [
                ...
                'Oluyole', 'Ona Ara', 'Orelope', 'Ori Ire', 'Oyo', 'Oyo East', 'Saki East',
                'Saki West', 'Surulere',
            ],
            'Plateau' => [
            ...
            'Yobe' => [
                ...
                'Jakusko', 'Karasuwa', 'Machina', 'Nangere', 'Potiskum', 'Tarmuwa', 'Yunusari', 'Yusufari',
            ],
            'Zamfara' => [
                'Anka', 'Bakura', 'Birnin Magaji/Kiyaw', 'Bukkuyum', 'Bungudu', 'Chafe', 'Gummi',
                'Gusau', 'Kankara', 'Kankia', 'Katsina', 'Kurfi', 'Kusada', 'Mai\'Adua', 'Malumfashi',
                'Mani', 'Mashi', 'Matazu', 'Musawa', 'Rimi', 'Sabuwa', 'Safana', 'Sandamu', 'Zango',
            ],
        ];
