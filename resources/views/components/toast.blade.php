...
@php
    $baseClasses = 'fixed z-50 flex items-center w-full max-w-xs p-4 mb-4 text-sm rounded-lg shadow-lg border transition-all duration-300 transform';
    $variants = [
    ...
    $classes = $baseClasses . ' ' . ($variants[$variant] ?? $variants['success']) . ' ' . ($positions[$position] ?? $positions['top-right']);
@endphp
