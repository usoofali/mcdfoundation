        ...
        <flux:navlist variant="outline">
            ...
            @if($isMember)
                ...
                <flux:navlist.group :heading="__('My Account')" class="grid">
                    <flux:navlist.item icon="home" :href="route('my.dashboard')"
                ...
                <flux:navlist.group :heading="__('Contributions')" class="grid">
                    <flux:navlist.item icon="currency-dollar" :href="route('my.contributions')"
                        :current="request()->routeIs('my.contributions*')" wire:navigate>{{ __('My Contributions') }}
                    </flux:navlist.item>
                    <flux:navlist.item icon="arrow-up-tray" :href="route('my.contributions.submit')"
                        :current="request()->routeIs('my.contributions.submit')" wire:navigate>{{ __('Submit Payment') }}
                    </flux:navlist.item>
                </flux:navlist.group>

                <flux:navlist.group :heading="__('Loans')" class="grid">
                    <flux:navlist.item icon="banknotes" :href="route('my.loans')" :current="request()->routeIs('my.loans*')"
                        wire:navigate>{{ __('My Loans') }}</flux:navlist.item>
                    <flux:navlist.item icon="plus" :href="route('my.loans.apply')"
                        :current="request()->routeIs('my.loans.apply')" wire:navigate>{{ __('Apply for Loan') }}
                    </flux:navlist.item>
                </flux:navlist.group>

                <flux:navlist.group :heading="__('Health')" class="grid">
                    <flux:navlist.item icon="heart" :href="route('my.claims')" :current="request()->routeIs('my.claims*')"
                        wire:navigate>{{ __('My Claims') }}</flux:navlist.item>
                    <flux:navlist.item icon="plus" :href="route('my.claims.submit')"
                        :current="request()->routeIs('my.claims.submit')" wire:navigate>{{ __('Submit Claim') }}
                    </flux:navlist.item>
                </flux:navlist.group>

                <flux:navlist.group :heading="__('Programs')" class="grid">
                    <flux:navlist.item icon="academic-cap" :href="route('my.programs')"
                        :current="request()->routeIs('my.programs*')" wire:navigate>{{ __('My Programs') }}
                    </flux:navlist.item>
                    <flux:navlist.item icon="magnifying-glass" :href="route('my.programs.browse')"
                        :current="request()->routeIs('my.programs.browse')" wire:navigate>{{ __('Browse Programs') }}
                    </flux:navlist.item>
                </flux:navlist.group>

                <flux:navlist.group :heading="__('Cashout')" class="grid">
                    <flux:navlist.item icon="banknotes" :href="route('my.cashout')"
                        :current="request()->routeIs('my.cashout*')" wire:navigate>{{ __('My Requests') }}
                    </flux:navlist.item>
                    <flux:navlist.item icon="plus" :href="route('my.cashout.request')"
                        :current="request()->routeIs('my.cashout.request')" wire:navigate>{{ __('Request Cashout') }}
                    </flux:navlist.item>
                </flux:navlist.group>
