...
<div class="space-y-6">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <flux:heading size="lg"
                                class="font-semibold text-base sm:text-lg text-neutral-900 dark:text-white">
    ...
    <div class="rounded-xl border border-neutral-200 bg-white p-4 sm:p-6 dark:border-neutral-700 dark:bg-neutral-800">
        <div class="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <flux:button variant="primary" icon="arrow-path" variant="outline" wire:click="clearFilters"
                    ...
                    <tbody class="divide-y divide-neutral-200 bg-white dark:divide-neutral-700 dark:bg-neutral-800">
                        @foreach($this->contributions as $contribution)
                            <tr class="hover:bg-neutral-50 dark:hover:bg-neutral-700/60">
                                ...
                                <td class="px-6 py-4">
                                    <span
                                        class="inline-flex items-center rounded-full bg-blue-100 px-2.5 py-0.5 text-xs font-medium text-blue-700 dark:bg-blue-900/40 dark:text-blue-200">
                                ...
                                <td class="px-6 py-4">
                                    @if($contribution->has_receipt)
                                        <flux:button variant="outline" size="sm" icon="document-text" class="gap-2"
