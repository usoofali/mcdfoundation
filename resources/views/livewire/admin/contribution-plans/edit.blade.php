...
new #[Layout('components.layouts.app', ['title' => 'Edit Contribution Plan'])] class extends Component
{
    ...
    public function save(): void
    {
        ...
        $this->redirect(route('admin.contribution-plans.show', $this->plan), navigate: true);
    }
...
<x-slot name="header">
    <div class="flex justify-between items-center">
        <h2 class="font-semibold text-xl text-gray-900 dark:text-white leading-tight">{{ __('Edit Contribution Plan') }}</h2>
